            ...
            <div class="col-12 col-md-8 col-lg-6">
                <div class="card border-0 shadow-lg p-4">
                    <form action="#" method="post" class="p-2">
                        <h1 class="text-center fw-bold">Login to Admin <br> Account</h1>
                        <hr class="mb-4">
                        <div class="mb-3">
                        ...
                        <div class="mb-3 input-group">
                            <input type="password" class="form-control" id="adminPassword" name="adminPassword" placeholder="Enter Admin's Password...."  onclick="showpassword()">
